...
class FlutterError extends Error with DiagnosticableTreeMixin implements AssertionError {
  ...
  /// Used this flag to indicate that an error message is being reported. If set
  /// to true, [DebugCreator] will collect widget runtime type details even on
  /// the profile or release mode, such as `Image ← Container ← RepaintBoundary`.
  /// The developer can use these widget details to help diagnose online errors.
  static bool isErrorReporting = false;
